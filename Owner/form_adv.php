    ...
    <!-- start: Header -->
                          ...
                          <div class="col-md-12">
						   ...
						   <form onkeypress="return event.keyCode != 13;" id="myForm" method="POST"> 
								<div class="form-group"><label class="col-sm-2 control-label text-right">Tanggal</label>
								  <div class="col-sm-10"><input name="tanggal" type="text" id="rangeDate" value="<?php echo "$data_jualan[tanggal]" ?>" placeholder="Please select Date Time" data-input></div>
								</div>
	  ...
	  <?php 
		if(isset($_POST['tambahData'])) {
			...
			echo "<script> window.location.href='../Owner/data_adv.php' </script>;";
