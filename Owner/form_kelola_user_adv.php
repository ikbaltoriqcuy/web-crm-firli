      ...
      <div class="container-fluid mimin-wrapper">
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Form Kelola User Advertiser</h3>
                        <p class="animated fadeInDown">
                          Kelola User <span class="fa-angle-right fa"></span> Kelola User Adv <span class="fa-angle-right fa"></span> Tambah Data User Advertiser
                        </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-md-12">
                      <div class="panel form-element-padding">
                        <div class="panel-heading">
                         <h4>Tambah Data Advertiser</h4>
                        </div>
                         <div class="panel-body" style="padding-bottom:20px;">
                          <div class="col-md-12">
							<?php 
								$query = mysqli_query($conn,"SELECT * FROM ds_account_adv where id_account_adv='$edit'");
								$data = mysqli_fetch_array($query);
							?>
						    <form method="POST">
								<div class="form-group"><label class="col-sm-2 control-label text-right">Nama Advertiser</label>
								  <div class="col-sm-10"><input required value="<?php echo "$data[nama_adv]"; ?>" name="nama" type="text" class="form-control" placeholder="Nama Adv"></div>
								</div>
								<div class="form-group"><label class="col-sm-2 control-label text-right">Username/Email</label>
								  <div class="col-sm-10">
								  <input onkeypress="return event.keyCode != 32;" required value="<?php echo "$data[username]"; ?>"  name="username" type="email" class="form-control" placeholder="Email">
								</div>
								</div>
								<div class="form-group"><label class="col-sm-2 control-label text-right">Password</label>
								  <div class="col-sm-10"><input onkeypress="return event.keyCode != 32;" required value="<?php echo "$data[password_adv]"; ?>" name="password" type="text" class="form-control" placeholder="Password"></div>
								</div>
								<div class="panel-body">
          ...
          <?php 
			if(isset($_POST['addUser'])){
				...
				echo "<script> window.location.href='../Owner/kelola_user_adv.php'; </script>";
