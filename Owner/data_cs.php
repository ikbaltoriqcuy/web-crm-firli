          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">Melihat Data Customer Service</h3>
                        <p class="animated fadeInDown">
                          Melihat Data <span class="fa-angle-right fa"></span> Melihat Data Customer Service
                        </p>
                        <div class="row" style="padding-left:10px;">
							...
							<script>
								function searchDataOnDate(sort) {
									if(sort != "") 
										window.location.href = "../Owner/data_cs.php?searchDate="+document.getElementById("rangeDate").value+ "&sort=" + sort;	  
									else
										window.location.href = "../Owner/data_cs.php?searchDate="+document.getElementById("rangeDate").value;
              ...
              <div class="col-md-12 top-25 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Data Customer Service</h3></div>
                    <div class="col-md-0">
                    </div>
                    <div class="panel-body">
                      <div class="btn-group" role="group">
							...
							<li><a href="../Owner/data_cs.php?sort=all<?php echo ($searchDate == "" ? "" : "&searchDate=".$searchDate ); ?>">all</a></li>
							<?php
								$akun_cs = mysqli_query($conn,"SELECT * FROM ds_account_cs");
											
								while($data = mysqli_fetch_array($akun_cs)){
											
										
						    ?>
								<li><a href="../Owner/data_cs.php?sort=<?php echo $data['username']; echo ($searchDate == "" ? "" : "&searchDate=".$searchDate ); ?>"><?php echo $data['username']; ?></a></li>
					...
					<script>
								function deleteData(data) {
								  ...
								  if (confirm("Apakah anda yakin mau hapus item ini!")) {
									window.location.href = "../Owner/data_cs.php?delete="+data ;
								  } else {
                    ...
                    <div class="panel-body">
					  ...
					  <?php 
						...
						if($sort != "" && $sort != "all" ){	
							$textquery .= " where cs='usrcs_".$sort."'";
						}
					  ...
					  ?>
                        <tr>
                          ...
                          <td>
                            <a href="../Owner/form_cs.php?id=<?php echo "$data[id_ss_jualan]"; ?>">
...
<script> 
        ...
        saveAs(new Blob([s2ab(wbout)],{type:"application/octet-stream"}), 'CS.xlsx');
        });
</script>
</script>
<!-- end: Javascript -->
