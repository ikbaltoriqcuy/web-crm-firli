<?php 
	...
	if(isset($_GET['delete'])){
		...
		$check = mysqli_query($conn, "DELETE FROM ds_account_owner WHERE id_account_own='".$_GET['delete']."'");
		if($check) {
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Kelola User Owner</h3>
                        <p class="animated fadeInDown">
                          Kelola User <span class="fa-angle-right fa"></span> Kelola User Owner
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 top-25 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Kelola User Owner</h3></div>
                      <div class="panel-body">
                        <a href="form_kelola_user_own.php">
                        <input type="button" class=" btn btn-3d btn-primary " value="Tambah User Owner"/>
                      </a>
                      </div>
                    <div class="col-md-0">
                    </div>
                    <div class="panel-body">
                      ...
                      <tbody>
                          <?php 
						$query = mysqli_query($conn,"SELECT * FROM ds_account_owner");
						 while($data = mysqli_fetch_array($query)){
					  ?>
                        <tr>
                          <td><?php echo "$data[id_account_own]"; ?></td>
                          <td><?php echo "$data[nama_owner]"; ?></td>
                          <td><?php echo "$data[username]"; ?></td>
                          <td>*****</td>
                          <td>
							<a href="form_kelola_user_own.php?edit=<?php echo "$data[id_account_own]"; ?>">
							...
							<script>
								function deleteData(data) {
								  ...
								  if (confirm("Apakah anda yakin mau hapus item ini!")) {
									window.location.href = "../Owner/kelola_user_own.php?delete="+data ;
								  } else {
                            ...
                            <button onClick=deleteData('<?php echo "$data[id_account_own]"; ?>') class=" btn btn-circle btn-mn btn-danger" value="primary">
