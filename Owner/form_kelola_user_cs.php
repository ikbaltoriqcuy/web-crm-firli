      ...
      <div class="container-fluid mimin-wrapper">
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Form Kelola User Customer Service</h3>
                        <p class="animated fadeInDown">
                          Kelola User <span class="fa-angle-right fa"></span> Kelola User CS <span class="fa-angle-right fa"></span> Tambah Data User Customer Service
                        </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-md-12">
                      <div class="panel form-element-padding">
                        <div class="panel-heading">
                         <h4>Tambah Data Customer Service</h4>
                        </div>
                         <div class="panel-body" style="padding-bottom:20px;">
                          <div class="col-md-12">
						  <?php 
								$query = mysqli_query($conn,"SELECT * FROM ds_account_cs where id_account_cs='$edit'");
								$data = mysqli_fetch_array($query);
							?>
                            <form onkeypress="return event.keyCode != 13 || event.keyCode != 32 ;" method="POST">
								<div class="form-group"><label class="col-sm-2 control-label text-right">Nama Customer Service</label>
								  <div class="col-sm-10"><input required value="<?php echo "$data[nama_cs]"; ?>" name="nama" type="text" class="form-control" placeholder="Nama CS"></div>
								</div>
								<div class="form-group"><label class="col-sm-2 control-label text-right">Username/Email</label>
								  <div class="col-sm-10">
								  <input required onkeypress="return event.keyCode != 32;"  value="<?php echo "$data[username]"; ?>"  name="username" type="email" class="form-control" placeholder="Email">
								  </div>

								</div>
								<div class="form-group"><label class="col-sm-2 control-label text-right">Password</label>
								  <div class="col-sm-10"><input onkeypress="return event.keyCode != 32;" required value="<?php echo "$data[password_cs]"; ?>" name="password" type="text" class="form-control" placeholder="Password"></div>
								</div>
								<div class="panel-body">
          ...
          <?php 
			if(isset($_POST['addUser'])){
				...
				echo "<script> window.location.href='../Owner/kelola_user_cs.php';</script>";
			}
		  ?>
      </div>
