<?php 
	...
	if(isset($_GET['delete'])){
		...
		$check = $databaseprovider->delete_achievment($_GET['delete']);
		if($check) {
                      ...
                      <div class="col-md-6 col-sm-12">
                       ...
                       <script>
								function searchDataOnDate() {
									window.location.href = "../Owner/input_target.php?searchDate="+document.getElementById("rangeDate").value;
                      ...
                      <tbody>
						<?php 
							if($searchDate !=""){
								...
								$textquery = "SELECT * FROM ds_achievment where  tanggal BETWEEN '$temp[0]' AND '$temp[1]'";	
							}else{
								$textquery = "SELECT * FROM ds_achievment";	
							}
                        ...
                        <tr>
                          ...
                          <td><?php echo "Rp.".number_format("$data[target]"); ?></td>
                          <td>
							<a href="../Owner/form_target.php?edit=<?php echo "$data[id_achievment]"; ?>" >
							...
							<script>
								function deleteData(data) {
								  ...
								  if (confirm("Apakah anda yakin mau hapus item ini!")) {
									window.location.href = "../Owner/input_target.php?delete="+data ;
								  } else {
						   ...
						   <button onClick=deleteData('<?php echo "$data[id_achievment]"; ?>') class=" btn btn-circle btn-mn btn-danger" value="primary">
