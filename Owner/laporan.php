                  ...
                  <div class="panel-body">
                       ...
                       <script>
								function searchDataOnDate() {
									window.location.href = "../Owner/laporan.php?searchDate="+document.getElementById("rangeDate").value;
                            ...
                            <div class="col-md-12 padding-0">
                                    ...
                                    <div class="panel box-v1">
                                      <div class="panel-heading bg-white border-none">
                                          <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                            <h4 class="text-left">Presentasi Acivment</h4>
                                          </div>
                                      </div>
                                      <div class="panel-body text-center">
                                        <h1><?php echo $all_acv_daily; ?></h1>
                                        <hr/>
                                      </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                  <div class="panel box-v1">
                                   <div class="panel-heading bg-white border-none">
                                          <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                            <h4 class="text-left">Margin Total</h4>
                                          </div>
                                      </div>
                                    <div class="panel-body text-center">
                                      <h1><?php echo $all_margin_total; ?></h1>
                                      <hr/>
                                    </div>
                                  </div>
                              </div>
                                <div class="col-md-4">
                                    <div class="panel box-v1">
                                      <div class="panel-heading bg-white border-none">
                                          <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                            <h4 class="text-left">Bonus All CS</h4>
                                          </div>
                                      </div>
                                      <div class="panel-body text-center">
                                        <h1><?php echo $all_bonus_cs; ?></h1>
                                        <hr/>
                                      </div>
                                    </div>
                                </div>
