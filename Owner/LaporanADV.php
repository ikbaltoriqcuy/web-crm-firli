                  ...
                  <div class="panel-body">
                       ...
                       <script>
								function searchDataOnDate() {
									window.location.href = "../Owner/laporanADV.php?searchDate="+document.getElementById("rangeDate").value;
                    ...
                    <div class="panel-body">
					  ...
					  ?>
                        <tr>
						  ...
						  <td><?php echo ($data['margin']-$data['add_spent']); ?></td>
                          <td><?php echo 0.5 *($data['margin']-$data['add_spent']); ?></td>
                         </tr>
					<?php 
					    }
					?>
