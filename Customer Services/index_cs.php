            ...
            <div id="content">
			   ...
			   <?php 
					   ...
					   $date = explode("/",date("m/d/Y"));
						...
						$presentase = ( $all_margin_total * 100 ) / $Target_bulanan_tim;
                            ...
                            <div class="col-md-12 padding-0">
                                    ...
                                    <div class="panel box-v1">
                                      <div class="panel-heading bg-white border-none">
                                          <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                            <h4 class="text-left">Target bulanan tim </h4>
                                          </div>
                                      </div>
									  <br/>
                                      <div style="word-wrap: break-word;"  class="panel-body text-left">
                                        <p style="font-size:2vw;"><?php echo "Rp.".number_format($Target_bulanan_tim); ?></p>
                                        <hr/>
                                      </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                  <div class="panel box-v1">
                                   <div class="panel-heading bg-white border-none">
									...
									<br/>
                                    <div style="word-wrap: break-word;" class="panel-body text-left">
                                      <p style="font-size:2vw;"><?php echo "Rp.".number_format($achievment_tim); ?></p>
                                      <hr/>
                                    </div>
                                  </div>
                              </div>
                                <div class="col-md-3">
                                    <div class="panel box-v1">
									  ...
									  <br/>
                                      <div style="word-wrap: break-word;" class="panel-body text-left">
                                        <p style="font-size:2vw;"><?php echo $presentase; ?>%</p>
                                        <hr/>
                                      </div>
                                    </div>
                                </div>
...
<!-- plugins -->
    ...
    <script src="asset/js/plugins/moment.min.js"></script>
    <script src="asset/js/plugins/jquery.datatables.min.js"></script>n
