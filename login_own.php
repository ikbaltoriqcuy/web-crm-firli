        ...
        <form class="form-signin" method="post">
          <div class="panel periodic-login">
              <div class="panel-body text-center">
                  <h4>Login <span style="font-size:16px;" class="label label-danger">Owner</span></h4><br>
                ...
                <div class="text-center" style="padding:5px;">
					...
					<a href="login_cs.php">Login Sebagai <span style="font-size:12px;" class="label label-warning">Customer Service</span></a>
                </div>
          </div>
        </form>
      </div>
	  ...
	  <?php 
		if(isset($_POST['SignIn'])){
			...
			$databaseprovider = new databaseprovider($conn); 
				$check = $databaseprovider->logIn($username, $password ,2);
				
				if($check) {
					$_SESSION['username'] = $username."_own";
					header('Location: Owner/index_own.php');
				}
		}
	  ?>
