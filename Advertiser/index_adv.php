			...
			<?php 
					   ...
					   $all_bonus = 0;
						...
						if($sort != "" && $sort != "all" ){	
						 ...
						 $textquery .=" AND tanggal BETWEEN '".$date[2]."-".$date[0]."-01' AND DATE_ADD('".$date[2]."-".$date[0]."-01', INTERVAL 1 MONTH) ";
						 ...
						 while($data = mysqli_fetch_array($query)){
							   ...
							   $achievment_tim += ($data['margin']-$data['add_spent']);
						 }
						...
						while($data = mysqli_fetch_array($query)){
							if ($data['type'] == "ADV"){
								$Target_bulanan_tim =$data['target'];
							}
						}
						
						$presentase = ( $all_gp_sales * 100 ) / $Target_bulanan_tim;
				?>
                        ...
                        <div class="col-md-12 padding-0">
                                    ...
                                    <div class="panel box-v1">
                                      <div class="panel-heading bg-white border-none">
                                          <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                            <h4 class="text-left">Target bulanan tim adv</h4>
                                          </div>
                                      </div>
                                      <div class="panel-body text-center">
                                        <h3><?php echo "Rp.".number_format($Target_bulanan_tim); ?></h3>
                                        <hr/>
                                      </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                  <div class="panel box-v1">
                                    <div class="panel-heading bg-white border-none">
                                          <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                            <h4 class="text-left">achievement tim</h4>
                                          </div>
                                      </div>
                                    <div class="panel-body text-center">
                                      <h3><?php echo "Rp.".number_format($achievment_tim); ?></h3>
                                      <hr/>
                                    </div>
                                  </div>
                              </div>
                                <div class="col-md-3">
                                  <div class="panel box-v1">
                                   <div class="panel-heading bg-white border-none">
                                          <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                            <h4 class="text-left">presentase</h4>
                                          </div>
                                      </div>
                                    <div class="panel-body text-center">
                                      <h3><?php echo number_format($presentase,2); ?> %</h3>
                                      <hr/>
                                    </div>
                                  </div>
                              </div>
                  ...
                  <div class="panel">
                    ...
                    <div class="panel-body">
						<div align="center"  class="row"> 
								...
								<select onchange=handleSelect(this)>
									...
									?>
											...
											value="index_adv.php?sort=<?php echo "$data[username]"; ?>"> <?php echo "$data[username]"; ?> </option> 
									<?php
										}
					  ...
					  <?php 
						...
						$date = explode("/",date("m/d/Y"));
						$textquery .=" tanggal BETWEEN '".$date[2]."-".$date[0]."-01' AND DATE_ADD('".$date[2]."-".$date[0]."-01', INTERVAL 1 MONTH) AND ";
